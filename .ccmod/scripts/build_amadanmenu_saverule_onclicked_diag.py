...
boundEvent._replace_prop(
    "CustomFunctionName",
    '"BndEvt__W_AmadanMenu_SaveButton_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"',
)
...
connect(s2i1, "ReturnValue", idToStr, "InInt")
...
out = MOD + r"\.ccmod\graphs\amadanmenu_saverule_onclicked_diag_body.t3d"
